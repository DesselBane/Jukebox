...
namespace Jukebox.Common.Settings
{
    public class SettingsService : ISettingsService
    {
        ...
        private readonly IOptionsMonitor<IndexOptions> _indexOptions;
        private readonly string _filePath;

        public SettingsService(IHostingEnvironment environment, IOptionsMonitor<IndexOptions> indexOptions)
        {
        ...
        {
            return Task.FromResult(_indexOptions.CurrentValue.IndexingPaths);
        }
    }
}