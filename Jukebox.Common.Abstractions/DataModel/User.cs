...
namespace Jukebox.Common.Abstractions.DataModel
{
    ...
    public class User
    {
        ...
        public static implicit operator ClaimsIdentity(User usr) => usr.ToClaimsIdentity();
        ...
        public bool HasClaim(string claimType, int value) => HasClaim(claimType, value.ToString());
