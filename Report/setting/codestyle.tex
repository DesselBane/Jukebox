...
\lstdefinelanguage{JavaScript}{
	morekeywords={ import, class, export, @NgModule, from, @Component, implements, extends,  @Input, @Output, new }, % keywords
	basicstyle=\ttfamily \color{black} \small \smaller,
	emphstyle={\color{vs_class}},
	emph={ AssignmentSearchComponent, AssignmentEditComponent, PipeModule, ModalModule, TooltipModule, ModelViewModul, TimepickerModule, FormsModule, CommonModule, assignmentRouting, AssignmentComponent, AssignmentOverviewComponent, AssignmentService, AssignmentModule, NgModule, OnInit, NavItemComponent, Component, EventEmitter, Input, Output, AngularMenuItem }, % classnames
	showspaces=false,
	showtabs=false,
	breaklines=true,
	showstringspaces=false,
